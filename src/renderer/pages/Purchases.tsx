                    ...
                    <div className="flex gap-2">
                      ...
                      {products.length > 0 && (
                        <button
                          ...
                          className="py-2 px-4 bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-200 text-gray-700 rounded-lg font-semibold text-sm flex items-center gap-2"
                            ...
                            return (
                              <tr
                                ...
                                className={`transition-colors cursor-pointer ${
                                  cartItem
                                    ? "bg-blue-50 hover:bg-blue-100 dark:bg-blue-900/40 dark:hover:bg-blue-900/60"
                                    : isSelected
                                      ? "bg-blue-50/60 hover:bg-blue-100/60 dark:bg-blue-900/20 dark:hover:bg-blue-900/40"
                              ...
                              >
                                ...
                                <td className="py-2 px-3">
                                  <span className={`font-medium ${cartItem ? "text-blue-700 dark:text-blue-400" : "text-gray-800 dark:text-gray-100"}`}>
                                    {product.nom}
                                  </span>
                                  {cartItem && (
                                ...
                                <td className="py-2 px-3" onClick={(e) => e.stopPropagation()}>
                                  <button
                                    ...
                                    className="p-1 rounded-full hover:bg-blue-100 dark:hover:bg-blue-900/50 text-blue-600 dark:text-blue-400 transition-colors"
                            ...
                            <div className="flex items-center gap-2">
                              <div className="flex items-center gap-1 shrink-0">
                                <button
                                  ...
                                  className="w-6 h-6 bg-gray-200 dark:bg-gray-600 dark:hover:bg-gray-500 rounded flex items-center justify-center hover:bg-gray-300"
                                >
                              ...
                              <div className="flex flex-col flex-1 min-w-0">
                                <input
                                  ...
                                  className={`w-full px-2 py-1 text-sm border rounded text-right bg-white dark:bg-gray-800 dark:text-gray-100 ${
                                ...
                                {item.prix_achat_ref != null && item.prix_achat_ref > 0 && (
                                  <span className={`text-[10px] ${item.prix_unitaire !== item.prix_achat_ref ? "text-orange-600 dark:text-orange-400" : "text-gray-500 dark:text-gray-400"}`}>
                        ...
                        <div>
                          ...
                          <div className="flex gap-2 mb-2">
                            <button
                              ...
                              className="flex-1 px-2 py-1 text-xs bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 dark:text-gray-200 rounded"
                            >
                              Total
                            </button>
                            <button
                          ...
                          <input
                            ...
                            className="w-full px-3 py-2 border-2 rounded-lg dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100"
                            min="0"
                          />
                        </div>
                      ...
                      <tr key={purchase.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                        ...
                        <td className="px-3 py-2 text-sm text-gray-500 dark:text-gray-400">
                          <div className="flex items-center gap-1.5">
                            <Package className="w-3.5 h-3.5 shrink-0 text-gray-400 dark:text-gray-500" />
                        ...
                        <td className="px-3 py-2 text-center">
                          <button
                            ...
                            className="inline-flex items-center gap-1 px-2 py-1 text-xs font-medium text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/30 hover:bg-blue-100 dark:hover:bg-blue-900/50 rounded-lg transition-colors"
