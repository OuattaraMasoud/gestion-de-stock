    ...
    <ProtectedRoute>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Dettes Clients</h1>
            <p className="text-gray-600 mt-1">
              {debts.length} client(s) avec des dettes
            </p>
          </div>
          <div className="text-right">
            <p className="text-xs text-gray-600">Total des dettes</p>
                      ...
                      >
                        ...
                        <div className="flex gap-2">
                          ...
                          <button
                            ...
                            className="px-3 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-lg font-semibold text-sm transition-all"
                          >
                            Montant libre
                          </button>
                        </div>
        ...
        {showReceipt && paymentReceipt && (
          <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full max-h-[95vh] flex flex-col">
              ...
              {/* Boutons */}
              <div className="p-4 bg-gray-50 border-t border-gray-200 flex gap-3 rounded-b-2xl flex-shrink-0">
                <button
                  onClick={() => setShowReceipt(false)}
                  className="flex-1 px-4 py-3 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-xl font-semibold transition-all flex items-center justify-center gap-2"
                >
                  <X className="w-5 h-5" />
                  Fermer
                </button>
